...
local resource_path = filesystem.scripts_dir() .. "\\resources\\Watch Dogs Plus\\"
...
menu.divider(menu_Root, "看门狗模式 Plus")
...
menu.text_input(menu_Root, "Text", { "wdtext" }, "", function(value)
    wdt = value
end)
...
menu.slider_float(menu_Root, "scale", { "wdscale" }, "", 0, 500, 60, 10, function(value)
    wdscale = value * 0.01
end)
menu.slider_float(menu_Root, "padding", { "wdpad" }, "", 0, 10, 1, 1, function(value)
    wdpad = value * 0.01
end)

menu.toggle_loop(menu_Root, "Draw Button", {}, "", function()
